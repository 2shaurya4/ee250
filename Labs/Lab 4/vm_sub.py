...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("vrjain/ipinfo")
    client.subscribe("vrjain/date")
    client.subscribe("vrjain/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("vrjain/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("vrjain/date", on_message_from_date)
    client.message_callback_add("vrjain/time", on_message_from_time)
...
def on_message_from_date(client, userdata, message):
   print("Custom callback  - Date Received: "+message.payload.decode())
def on_message_from_time(client, userdata, message):
   print("Custom callback  - Time Received: "+message.payload.decode())
